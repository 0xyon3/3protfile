              ...
              <div className="hidden md:grid h-64 lg:h-72 w-full grid-cols-3 gap-1.5 bg-black/20 p-2">
                {heroRowItems.map((image, imageIndex) => (
                  <div
                    ...
                    className="flex items-center justify-center overflow-hidden border border-white/[0.04] bg-black/30"
                  >
                    <img
                      src={image}
                      alt={`${project.title} preview ${imageIndex + 1}`}
              ...
              <div className={`mt-4 ${bodyGalleryVisibility} ${galleryGap} ${galleryColumns}`}>
                {bodyGalleryItems.map((image, imageIndex) => (
                  <div
                    ...
                    className={`flex items-center justify-center overflow-hidden border border-white/[0.04] bg-black/20 ${galleryItemHeight}`}
                  >
                    <img
                      src={image}
