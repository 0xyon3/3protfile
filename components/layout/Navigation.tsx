  ...
  >
    <div className="container mx-auto flex max-w-6xl items-center justify-between px-6">
      ...
      <div className="flex cursor-pointer items-center gap-3 group" onClick={onScrollTop}>
        <span className="font-display text-xl font-bold tracking-tight text-white transition-colors group-hover:text-[#c4a7e7]" style={{ fontVariantNumeric: 'lining-nums' }}>
          yon3
        </span>
      </div>
      ...
      <div className="hidden items-center gap-8 md:flex">
        ...
        <AudioMenuButton
          ...
          buttonClassName="border border-white/10 bg-white/5 p-2 text-white/60 transition-all hover:bg-white/10 hover:text-white"
          iconSize={16}
        />

        <a
          href="/cv.html"
          className="border border-white/10 px-4 py-2 text-sm text-white/70 transition-all hover:border-white/20 hover:text-white"
        >
          CV
        </a>
        ...
        <a
          ...
          className="bg-white px-4 py-2 text-sm font-medium text-[#09090b] transition-all hover:bg-white/90"
        >
          GitHub
        </a>
      </div>
