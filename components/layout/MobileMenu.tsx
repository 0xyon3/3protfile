    ...
    {isOpen && (
      ...
      >
        ...
        <div className="mt-4 flex gap-4">
          <a
            href="/cv.html"
            className="border border-white/10 px-6 py-3 text-sm text-white/70 transition-all hover:border-white/20 hover:text-white"
          >
            View CV
          </a>
          <a
            ...
            className="bg-white px-6 py-3 text-sm font-medium text-[#09090b]"
          >
            GitHub
          </a>
        </div>
        ...
        <button
          onClick={onClose}
          className="mt-8 border border-white/10 p-3 text-white/50 transition-colors hover:text-white"
        >
          <X size={24} />
        </button>
      </motion.div>
