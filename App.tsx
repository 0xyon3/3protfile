...
import { FallingLines } from './components/effects/FallingLines';
      ...
      {audio.needsAudioUnlock && (
        <div className="fixed bottom-6 right-6 z-[60]">
          <button
            ...
            className="flex items-center gap-3 border border-white/10 bg-white/5 px-5 py-3 text-xs font-medium text-white/80 shadow-2xl backdrop-blur-xl transition-all hover:bg-white/10"
          >
            Enable Sound
          </button>
        </div>
